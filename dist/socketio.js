...
module.exports = function (server) {
  ...
  io.on("connect", function (socket) {
    ...
    socket.on("chatting", function (data) {
      console.log(data);
      isOnline(io, data.reciveid) ? socket.to(data.reciveid).to(mongoID).emit("reciverPeer", data) : socket.to(mongoID).emit("reciverPeer", data);
  ...
  let emitStatus = (io, mongoID, isonline) => {
